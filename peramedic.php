...
if(isset($_POST['Submit'])){
      ...
      $phone =  $_POST['phone'];
        ...
        $sql = "INSERT INTO `peramedic`(`full_name`, `email`, `address`, `phone`) VALUES ('$full_name','$email','".mysqli_real_escape_string($db,$address)."','$phone')";
